function [iteration,n_actions_taken,time_taken,unknown_state] = fixed_horizon_search(dim1,dim2,res,objLocationsindices,target_id,horizon,plot_flag)
% FIXED_HORIZON_SEARCH
...
%for itr = 1:1
    ...
    % Goal: reveal as much unknown space as possible without increasing
    % horizon
    [info_gain,action_sequence] = plan2(visible,known,occupied,free,dim1,dim2,res,horizon,0);
    info_gain;
    if (info_gain < 1)
