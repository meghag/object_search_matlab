function [goal_config,nsteps,first_action] = dfs(start,dim1,dim2,res,target_id)
% DFS - This function performs a depth first search on a tree of
% configurations until it knows the state of all voxels. The tree is gradually
