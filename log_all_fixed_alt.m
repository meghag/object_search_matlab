function log_all_fixed_alt(dim1,dim2,res,max_N,target_id,horizon)
...
save('fixedlog_3by4_horizon1_20trials.mat', 'log_array');
%save('fixedlog_4by4_horizon1_20trials.mat', 'log_array');
end
